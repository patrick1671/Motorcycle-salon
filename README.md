...
I wanted to build an application that allowed users to configure and order motorcycle in a virtual salon. I started this process by using the 'create-react-app' then adding 'react-router'.
